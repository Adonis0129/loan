...
contract LOANStaking is BaseContract, ILOANStaking, CheckContract, BaseMath {
    ...
    function increaseF_FURFI(uint _FURFIFee) external override {
    ...
    function increaseF_FURUSD(uint _FURUSDFee) external override {
    ...
    function _requireCallerIsTroveManager() internal view {
        require(msg.sender == troveManagerAddress, "LOANStaking: caller is not TroveM");
    }
